...
void DynamicCharacterController::setup (btScalar height, btScalar width, btScalar stepHeight, Ogre::SceneNode* node)
{
	...
	OgreMotionState* myMotionState = new OgreMotionState(startTransform, node);
